...
@WebServlet(urlPatterns = "/developers/delete/form")
public class DeleteDeveloperFormController extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        DeveloperConverter developerConverter = new DeveloperConverter(skillsConverter, companiesConverter,
                customersConverter);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/jsp/developer/deleteDevelopersFormSearch.jsp").forward(req, resp);
    }
}
