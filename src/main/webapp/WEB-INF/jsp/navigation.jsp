<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Companies<span
                    class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="/companies/create/form">Create company</a></li>
                    <li><a href="/companies/form">Find company</a></li>
                    <li><a href="/companies/allCompanies">Find all companies</a></li>
            ...
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Customers<span
                    class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="/customers/create/form">Create customer</a></li>
                    <li><a href="/customers/form">Find customer</a></li>
                    <li><a href="/customers/allCustomers">Find all customers</a></li>
                    <li><a href="/customers/update/form">Update customer</a></li>
                    <li><a href="/customers/delete/form">Delete customer</a></li>
                </ul>
            </li>
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Developers<span
                    class="caret"></span></a>
                <ul class="dropdown-menu">
